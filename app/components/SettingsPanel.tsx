    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="pixel-box relative z-10 p-[20px] w-[360px] max-h-[80vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-[16px]">
          ...
          <button onClick={onClose} className="text-[22px] cursor-pointer hover:text-[var(--accent)]">✕</button>
        </div>
        ...
        <div className="flex flex-col gap-[8px] mb-[16px]">
          {fontOptions.map((f) => (
            ...
            >
              <span className="text-[18px]" style={{ fontFamily: f.id === 'vt323' ? 'var(--font-vt323)' : 'var(--font-grandstander)' }}>
                Aa Ắ Ồ
              </span>
        ...
        <div className="flex flex-col gap-[8px] mb-[12px]">
          ...
          >
            ...
            <span className="text-[18px]">Groq (Online)</span>
          </button>
          <button
          ...
          >
            <span className="text-[18px]">💻</span>
            <span className="text-[18px]">Ollama (Ngoại tuyến)</span>
          </button>
        </div>
          ...
          <div className="flex flex-col gap-[8px] p-[8px] bg-[var(--bg-warm)] border-[2px] border-solid border-[var(--border)]">
            <div>
              ...
              <input
                ...
                className="w-full py-[4px] px-[8px] border-[2px] border-solid border-[var(--border)] bg-white text-[18px]"
              />
            </div>
            <div>
        ...
        <div className="p-[10px] bg-[var(--bg-warm)] border-[2px] border-solid border-[var(--border)] flex flex-col gap-[6px] text-[18px]">
